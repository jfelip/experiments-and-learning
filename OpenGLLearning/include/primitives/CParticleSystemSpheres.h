#ifndef GLVIEWER_PARTICLE_SYSTEM_SPHERES_H
#define GLVIEWER_PARTICLE_SYSTEM_SPHERES_H
...
public:
    ...
    GLuint getParticleSize(){ return m_particleSize;}

	void setPointSize(const GLuint& s){	m_particleSize = s; }
    ...
    void rotate (const T_real r[4])		{m_transform.rotate( CQuaternion<T_real>(r) );}
